...
include '../../../koneksi.php';
 ...
 if($img != "") {
  ...
  $query  = "UPDATE siswa SET nis = '$nis', nama = '$nama',kelas = '$kelas',jurusan = '$jurusan',tempat_lahir = '$tempat_lahir',tgl_lahir = '$tgl_lahir', jk = '$jk',alamat = '$alamat',img = '$nama_gambar_baru'";
  $query .= "WHERE nis = '$nis'";
  $result = mysqli_query($koneksi, $query);
  // periska query apakah ada error
  if(!$result){

...
<div style="width: 850px;height: 260px;margin-bottom: -12px;padding:; background-image: url('../../../assets/img/balangko.png');">
            ...
            <img style="position: absolute;margin-left: 48px;margin-top: 8px; width: 50px;" src="../../../assets/img/madep.png">
            ...
            <p style="letter-spacing: 2px;margin-left: 150px;padding-top: 90px;width: 240px; text-align: left; font-size: 15px"><b>KARTU ABSENSI</b></p>
            ...
            <ol style="padding-left: 480px;font-family: arial;font-size: 11px;text-align: justify;padding-right: 38px;margin-top: -5px;">
